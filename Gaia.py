...
for table in votable.iter_tables():
    ...
    for i in arrayDesignation:
        ...
        with open("outputsc" + ".csv", 'a+') as file:
            ...
            designationoutput = designationoutput.replace("b'", "")
            designationoutput = designationoutput.replace("'", "")
            ...
            file.write(designationoutput + "," + str(rahoutput) + "," + str(decoutput) + "," + str(distance) + "," + str(apparent_magnitude) + "," + str(calcsspectral(float(teffoutput)) + str(random.randrange(1,9)) + "V") + "," + "," + str(radsoloutput) + "," + str(teffoutput) + "\n")
